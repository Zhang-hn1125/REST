def generate_command(star_file: str, mask_dir: str=None, ncpu: int=10, gpu_memory: int=10, ngpu: int=4, pixel_size: float=10, also_denoise: bool=True):
        """
        \nGenerate recommanded parameters for "REST.py refine" for users\n
        ...
        import mrcfile
        import numpy as np
        s="REST.py refine --input_dir {} ".format(tomo_dir)
...
#            s+="--batch_size {} ".format(batch_size)
 ...
 #       else:
        ...
        from REST.preprocessing.cubes import mask_mesh_seeds

...
import numpy as np
import os, sys
from REST.preprocessing.simulate import apply_wedge
from REST.util.norm import normalize
from REST.util.toTile import reform3D
import mrcfile
from REST.util.image import *
from REST.util.metadata import MetaData,Label,Item
from REST.util.dict2attr import idx2list
from tqdm import tqdm
# from REST.training.data_sequence import get_gen_single
def predict(args):
    ...
    #check gpu settings
    from REST.bin.refine import check_gpu
    check_gpu(args)
